    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                .requestMatchers("/usuario/registro", "/usuario/login", "/instrumento/registrar", "/instrumento/listar","/instrumento/actualizar", "/instrumento/**", "/reserva/**").permitAll() // Permitir acceso sin autenticación
